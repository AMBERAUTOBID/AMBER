 ...
 * the right — so the layout does not jump when the rows land. `.skeleton`
 * (globals.css) is the shimmer the owner asked for 2026-08-21; pure CSS, so
 * it costs the load nothing.
 */
export default function Loading() {
  return (
    <Container className="py-8 sm:py-10">
      <div className="skeleton h-4 w-48 rounded-full" />
      <div className="skeleton mt-3 h-8 w-72 max-w-full rounded-lg" />
